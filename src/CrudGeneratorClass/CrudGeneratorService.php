...
namespace zamshed\CrudGenerator\CrudGeneratorClass;
...
class CrudGeneratorService
{
    ...
    {
        return file_get_contents(base_path("vendor/zamshed/crud-package-laravel-v10/src/resources/stubs/$type.stub"));
    }
